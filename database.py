...
class DatabaseManager:
    ...
    def insert_cumplimiento_data(self, df):
        ...
        try:
            ...
            for _, row in df_clean.iterrows():
                ...
                (indicador, secretaria, dependencia, sector, programa, producto, eje, meta_anual, avance_actual, porcentaje_cumplimiento, ejecutado, presupuesto_inicial, presupuesto_definitivo, fecha_actualizacion)
                VALUES (:indicador, :secretaria, :dependencia, :sector, :programa, :producto, :eje, :meta_anual, :avance_actual, :porcentaje, :ejecutado, :presupuesto_inicial, :presupuesto_definitivo, :fecha)
                """
                ...
                eje = str(row.get('Eje', 'Eje General'))[:200]
    ...
    def insert_financiero_data(self, df):
        ...
        try:
            ...
            for _, row in df_clean.iterrows():
                ...
                (concepto, dependencia, sector, programa, eje, presupuesto_anual, presupuesto_definitivo, ejecutado, disponible, pagos, porcentaje_ejecucion, fecha_reporte)
                VALUES (:concepto, :dependencia, :sector, :programa, :eje, :presupuesto_anual, :presupuesto_definitivo, :ejecutado, :disponible, :pagos, :porcentaje, :fecha)
                """
    ...
    def get_cumplimiento_data(self):
        ...
        try:
            query = """
            SELECT 
                indicador, secretaria, dependencia, sector, programa, producto, eje,
    ...
    def get_financiero_data(self):
        ...
        try:
            query = """
            SELECT 
                concepto, dependencia, sector, programa, eje,
